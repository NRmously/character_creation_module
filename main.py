...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the attack power for each class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate the amount of blocked damage for each class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate the units to use the special ability of each class."""
    if char_class == 'warrior':
